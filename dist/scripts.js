...
(function ($) {
  function wpcLoadUsersList() {
    ...
    var table = new datatables_net_dt__WEBPACK_IMPORTED_MODULE_0__["default"]('#wpc-users', {
      paging: false,
      serverSide: false,
      columns: [{
        data: 'id'
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwpc_test"] = self["webpackChunkwpc_test"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["styles"], () => (__webpack_require__("./src/index.scss")))
